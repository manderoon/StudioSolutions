...
from .models import Skill, IlcActivity, StudentIlcActivity, Product
...
class AddStudentActivityForm(forms.ModelForm):
    ...
    engagement_ranking = forms.IntegerField(required=False, label='Engagement_Ranking')  # Field name made lowercase.   
    relevancy_ranking = forms.IntegerField(required=False, label='Relevancy_Ranking')  # Field name made lowercase.     
    ...
    class Meta:
        ...
        fields = ['activity', 'product', 'engagement_ranking', 'relevancy_ranking', 
